...
import hexdoc_azazelshexes

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class AzazelshexesPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return AzazelshexesModPlugin(branch=branch)


class AzazelshexesModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "azazelshexes"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_azazelshexes, "_templates"
